...
public final class Logging {
	...
	private static FileChannel openLogFile() {
		...
		Path logfilePath = Paths.get("MultiYggdrasil.log").toAbsolutePath();
		try {
	...
	public static void log(Level level, String message, Throwable e) {
		...
		String log = "[MultiYggdrasil] [" + level + "] " + message;
		if (e != null) {
		...
		if (logfile != null) {
			try {
				...
				out.println("[MultiYggdrasil] [ERROR] Error writing to log file: " + ex);
			}
		}
	}
}
